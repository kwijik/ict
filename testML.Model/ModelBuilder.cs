...
namespace TestML.Model
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\AppData\Local\Temp\66970740-44d1-4981-941c-a74d302ab9dd.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\AppData\Local\Temp\MLVSTools\testML\testML.Model\MLModel.zip";
        ...
        {
            Console.WriteLine("in CreateModel");
        ...
        {
            Console.WriteLine("in TrainModel");
